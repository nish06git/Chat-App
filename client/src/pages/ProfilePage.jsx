...
const ProfilePage = () => {
 ...
 // You can add logic to save the data here before navigating
    navigate('/');
    return ;
    }
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-8 flex-1">
          ...
          <label htmlFor="avatar" className="flex items-center gap-4 cursor-pointer">
            ...
            <img
              ...
              alt="Profile avatar"
              className={`w-12 h-12 object-cover border border-gray-400 transition-all ${
                selectedImg && 'rounded-full'}`}
            />
            <span className="text-sm text-gray-400 hover:text-violet-400 transition">
